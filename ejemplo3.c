...
int main(){
    int *arreglo = NULL, *arreglo2 = NULL, num, cont; //Recomendable asignarle nulo a un apuntador;
    ...
    if(arreglo != NULL){        
        ...
        num *=2;
        arreglo2 = (int*)realloc(arreglo, num*sizeof(int)); //realloc recibe la zona de memoria que se reservo, y el nuevo tamaño
        if(arreglo2 != NULL){ 
            arreglo = arreglo2;       
            for(; cont <num; cont++){
                printf("Ingresa el elemento %d del conjunto\n", cont+1);
